...
variable "csr" {
  ...
  type = object({
    preferred_trust_chain = optional(string) # Preferred trust chain for the CSR
    country_code          = optional(string) # Country code for the CSR
    state                 = optional(string) # State or province for the CSR
    city                  = optional(string) # City for the CSR
    organization          = optional(string) # Organization name for the CSR
    organizational_unit   = optional(string) # Organizational unit for the CSR
  })
  default  = {}
  nullable = false
}
...
variable "organization" {
  ...
  type = object({
    ...
    address_line_two = optional(string) # Organization address line two
...
variable "admin_contact" {
  ...
  type = object({
    organization     = optional(string) # Admin contact organization
    title            = optional(string) # Admin contact title
    ...
    country_code     = optional(string) # Admin contact country code
    region           = optional(string) # Admin contact region
    city             = optional(string) # Admin contact city
    address_line_one = optional(string) # Admin contact address line one
    address_line_two = optional(string) # Admin contact address line two
    postal_code      = optional(string) # Admin contact postal code
  })
  nullable = false
}
...
variable "tech_contact" {
  ...
  type = object({
    organization     = optional(string) # Tech contact organization
    title            = optional(string) # Tech contact title
    ...
    country_code     = optional(string) # Tech contact country code
    region           = optional(string) # Tech contact region
    city             = optional(string) # Tech contact city
    address_line_one = optional(string) # Tech contact address line one
    address_line_two = optional(string) # Tech contact address line two
    postal_code      = optional(string) # Tech contact postal code
  })
  nullable = false
}
